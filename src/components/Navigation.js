...
function Navigation(){
    ...
    return (
        <nav id="mainNavbar" className="navbar navbar-expand-md sticky-top">
            <a href="#" className="navbar-brand" aria-label="brand">Portfolio</a>
            ...
            <div className="collapse navbar-collapse" id="navLinks">
                <ul className="navbar-nav">
                    <li className="nav-item" aria-label="primary">
                        <a href="#row1" className="nav-link">About</a>
                    </li>
                    <li className="nav-item" aria-label="secondary">
                        <a href="#row3" className="nav-link">Experience</a>
                    </li>
                    <li className="nav-item" aria-label="tertiary">
                        <a href="#row4" className="nav-link">Hobbies</a>
                    </li>
                    <li className="nav-item" aria-label="quaternary">
                        <a href="#row6" className="nav-link">Languages</a>
                    </li>
                    <li className="nav-item" aria-label="quinary">
